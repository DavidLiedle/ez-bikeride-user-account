...
class CreateGpxContentCommand extends ContainerAwareCommand
{
    protected function configure()
    {
        $this
            ->setName('ezsystems:gpx-fieldtype:create-content')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $createStruct = $contentService->newContentCreateStruct(
            $repository->getContentTypeService()->loadContentTypeByIdentifier('gpx'),
            'eng-GB'
        );
        $createStruct->setField('gpx', 'https://master-7rqtwti-oefgq6mvzxavw.us.platform.sh/assets/maps/St_Louis_Zoo_sample.gpx', 'eng-GB');
